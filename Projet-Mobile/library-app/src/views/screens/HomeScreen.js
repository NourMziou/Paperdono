  ...
  return (
    <SafeAreaView style={{backgroundColor: COLORS.green1, flex: 1}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Reward List */}
                <Text style={{fontWeight:'bold',fontSize:30,paddingHorizontal: 20,color:COLORS.white1}}>Library Dashboard</Text>

        <Text style={style.title}>Select reward to be given:</Text>
