  ...
  return (
    <SafeAreaView style={{backgroundColor: COLORS.green1, flex: 1}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Reward List */}
                <Text style={{fontWeight:'bold',fontSize:30,paddingHorizontal: 20,color:COLORS.white1}}>Recycling Unit Dashboard</Text>

        <Text style={style.title}>Enter the weight of the donated papers in Kg:</Text>
...
const style = StyleSheet.create({
  ...
  title: {fontSize: 15, fontWeight: 'bold', paddingHorizontal: 20,color:COLORS.pink1,marginTop:5},
  iconContainer: {
    height: 25,
    width: 25,
    backgroundColor: COLORS.pink1,
